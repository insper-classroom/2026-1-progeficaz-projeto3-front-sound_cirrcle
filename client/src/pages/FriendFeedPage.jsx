  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f8fafc" }}>
      ...
      <main style={{ padding: "2rem 1rem", maxWidth: "800px", margin: "0 auto" }}>
        ...
        {error && <div style={{ padding: "0.75rem 1rem", background: "#fef2f2", color: "#b91c1c", borderRadius: "10px", fontSize: "0.85rem" }}>{error}</div>}
        {!loading && ratings.length === 0 && <p style={{ color: "#94a3b8" }}>Este amigo ainda não avaliou nenhuma música.</p>}
